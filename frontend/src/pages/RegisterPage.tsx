...
export const RegisterPage: React.FC = () => {
  ...
  const handleSocialLogin = async (provider: 'google' | 'github' | 'discord') => {
    try {
      ...
      setError(err.message || `${provider} ile kayıt başarısız`);
      ...
      <div className="hidden lg:flex lg:w-1/2 items-center justify-center relative z-10 p-12">
        <div className="max-w-md text-center">
          ...
          <p className="text-xl text-gray-400 mb-6 leading-relaxed">
            Ücretsiz hesap oluşturun ve AI'nın gücünü keşfedin
          </p>

          {/* Perks */}
          <div className="space-y-4 text-left max-w-xs mx-auto">
            {[
              { emoji: '🎁', text: '500 ücretsiz kredi ile başlayın' },
              { emoji: '⚡', text: '40+ AI modeline erişim' },
              { emoji: '🔒', text: 'Güvenli ve hızlı üretim' },
              { emoji: '💳', text: 'Kredi kartı gerektirmez' },
            ].map((perk) => (
