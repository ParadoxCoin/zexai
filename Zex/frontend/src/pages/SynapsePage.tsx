...
const FEATURE_PILLS = [
  { id: "single_command_agency", label: "Single Command Agency", badge: "Hot", icon: Sparkles, prompt: "Create a 15-second cinematic TikTok UGC ad campaign for my new AI product with a script, visual storyboard, and Kling/Seedance video generation prompts." },
...
const DEFAULT_SKILLS = [
  { id: "single_command_agency", name: "single-command-agency", category: "Agentic Studio",       installed: true,  rating: 5.0, uses: 15400, desc: "Higgsfield tarzı tek komutla kampanya planlama, görsel/video üretimi ve senaryo storyboard hazırlama.", actions: ["Kampanya tasarla", "Karakter/Sahne planla", "Video promptları üret"] },
